...
valid_data: Dict[str, Dict[str, Any]] = {
    ...
    "memory": {"value": 16000, "used": 8000, "available": 8000,
               "percentage": 50.0},
    "storage": {"size": 100000, "used": 40000, "free": 60000,
                "percentage": 40.0, "cls": "SSD"},
...
def test_get_dashboard_data_missing_required_fields(
    client: TestClient,
    missing_field_service_layer: str
) -> None:
