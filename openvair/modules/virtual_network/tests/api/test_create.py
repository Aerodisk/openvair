...
# def test_create_virtual_network_success(client: TestClient, bridge: Dict) -> None:
...
# def test_create_virtual_network_empty_port_groups(client: TestClient, bridge: Dict) -> None:
...
# def test_create_virtual_network_missing_fields(client: TestClient, bridge: Dict) -> None:
#     """port_groups must not be empty."""
#     payload = VirtualNetwork(
#         network_name=generate_test_entity_name('vnet'),
#         forward_mode='bridge',
...
def test_create_virtual_network_unauthorized(bridge: Dict, unauthorized_client: TestClient) -> None:
    """Test successful virtual network creation."""
    payload = VirtualNetwork(
        network_name=generate_test_entity_name('vnet'),
        forward_mode='bridge',
    ...
    response = unauthorized_client.post('/virtual_networks/create/', json=payload)
