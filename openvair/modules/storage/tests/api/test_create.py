...
def test_create_storage_localfs_success(client: TestClient) -> None:
...
def test_create_storage_missing_name(client: TestClient) -> None:
...
def test_create_storage_missing_storage_type(client: TestClient) -> None:
...
def test_create_storage_nonexistent_path(client: TestClient) -> None:
...
def test_create_storage_duplicate_path(client: TestClient) -> None:
...
def test_create_storage_unauthorized(unauthorized_client: TestClient) -> None:
