...
from openvair.modules.virtual_machines.vnc.process_manager import WebsockifyProcessManager
...
class VncSessionCoordinator:
    ...
    def start_vnc_session(
        ...
        try:
            ...
            LOG.info(f"Successfully started VNC session for VM {vm_id}: {vnc_url}")
            return result
            ...
            if started_pid:
                try:
                    ...
                    LOG.warning(f"Failed to cleanup websockify process: {cleanup_error}")
    ...
    def get_system_status(self) -> Dict:
        ...
        return {
            ...
            'system_health': 'healthy' if port_stats['free_ports'] > 10 else 'warning'
        }
