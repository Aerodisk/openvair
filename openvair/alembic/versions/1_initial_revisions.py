...
Revision ID: 1
Revises:
Create Date: 2025-09-10 14:53:05.430599
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            'status',
            sa.Enum(
                'ONLINE', 'OFFLINE', 'UNKNOWN', 'CORDONED', name='node_status'
            ),
            nullable=False,
        ),
        sa.Column('last_seen', sa.DateTime(timezone=True), nullable=True),
        sa.Column('capacity_cpu', sa.Integer(), nullable=True),
        sa.Column('capacity_mem_mb', sa.Integer(), nullable=True),
        sa.Column('capacity_storage_gb', sa.Integer(), nullable=True),
        sa.Column('alloc_cpu', sa.Integer(), nullable=True),
        sa.Column('alloc_mem_mb', sa.Integer(), nullable=True),
        sa.Column('alloc_storage_gb', sa.Integer(), nullable=True),
        sa.PrimaryKeyConstraint('id'),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ['node_id'], ['cluster_nodes.id'], ondelete='SET NULL'
        ),
        sa.PrimaryKeyConstraint('id'),
    )
